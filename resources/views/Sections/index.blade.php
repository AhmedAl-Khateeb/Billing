                            ...
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-xl-t-0">
                                        <a class="modal-effect btn btn-success" data-effect="effect-newspaper" data-toggle="modal" href="#modaldemo8">اضافة قسم جديد+ </a>
                                    </div>
...
$('#modaldemo9').on('show.bs.modal', function(event) {
    ...
    modal.find('form').attr('action', 'sections/destroy/' + id);
})
</script>
